...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <main className="bg-white dark:bg-gray-900">
        ...
        <div className="snap-y snap-mandatory overflow-y-hidden">
 ...
 rounded-full w-80 h-80 mt-20 overflow-hidden"
          ...
          <div className="snap-start min-h-screen bg-gray-50 dark:bg-gray-800">
          ...
          <div className="snap-start min-h-screen bg-white dark:bg-gray-900">
            <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
              <div className="lg:text-center">
                <h2 className="text-base text-indigo-600 dark:text-indigo-400 font-semibold tracking-wide uppercase">
                  Skills
